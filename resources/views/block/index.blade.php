                        ...
                        <div class="col-lg-12 col-md-12">
                            ...
                            <div class="card card-default">
                                <div class="card-header">
                                    <x-card-title route="{{ route('admin.block.create') }}" type="primary" title="Add Record" />
                                    <x-card-tools route="{{ route('admin.block.list') }}" type="primary" title="Clear Search" />
                                </div>
                                <!-- /.card-header -->
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-sm display nowrap" style="width:100%" id="block-table">
                                            <thead>
                                                <th>S.No</th>
                                                <th>Code</th>
                                                <th>Name</th>
...
<script>
    ...
    var oTable = $('#block-table').DataTable({
        lengthMenu: [
